...
android {
    ...
    // 1. Cambia esto a 37 para cumplir con el requisito de las librerías
    compileSdk = 37
    ...
    defaultConfig {
        ...
        // 2. Puedes mantener tu targetSdk actual o subirlo si estás listo para los cambios de comportamiento de Android 15
        targetSdk = 37
